...
> | Term | Definition |
> |------|-----------|
> | **Tool Calling** | LLM requesting execution of external functions during reasoning |
> | **MCP** | Model Context Protocol — open standard for agent-tool communication |
> | **Orchestration** | Coordinating multiple AI steps/tools to complete a complex task |
>
...
11. **Agents are read-only by default** — only generate SELECT queries; no DML/DDL unless explicitly given a tool
12. **SNOWFLAKE_INTELLIGENCE_ADMIN** role required to create agents for CoWork (not just CORTEX_AGENT_USER)
...
<p align="center">
  ...
  <a href="./1.5_Snowflake_Intelligence.md">Next: 1.5 CoWork →</a>
</p>
