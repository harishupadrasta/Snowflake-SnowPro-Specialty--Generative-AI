...
> | Term | Definition |
> |------|-----------|
> | **RAG** | Retrieval-Augmented Generation — retrieve context → feed to LLM → generate grounded answer |
> | **BM25** | Best Matching 25 — classical keyword ranking algorithm |
> | **Hybrid Search** | Combining keyword + semantic search |
> | **Reranking** | Second-pass scoring with a more expensive model |
>
