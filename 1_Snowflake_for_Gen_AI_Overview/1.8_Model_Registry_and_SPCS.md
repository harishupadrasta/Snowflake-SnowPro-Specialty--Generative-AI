...
> | Term | Definition |
> |------|-----------|
> | **Model Registry** | Catalog for versioning and deploying ML models |
> | **SPCS** | Snowpark Container Services — run Docker containers with GPU in Snowflake |
> | **Compute Pool** | Dedicated GPU/CPU nodes for running containers |
> | **log_model** | Python API for registering models |
> | **Service Function** | SQL function that calls a running container |
> | **Image Repository** | Snowflake-managed Docker registry |
>
