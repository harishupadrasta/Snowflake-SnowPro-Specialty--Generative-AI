...
> | Term | Definition |
> |------|-----------|
> | **REST API** | HTTP-based interface for external apps |
> | **Prompt Caching** | Storing repeated prompt prefixes to reduce cost/latency |
> | **Fine-Tuning** | Specializing a model on custom data (FINETUNE function) |
> | **LoRA / PEFT** | Parameter-Efficient Fine-Tuning techniques |
> | **JWT / PAT** | Authentication tokens for API access |
> | **Tool Calling** | LLM requesting external function execution |
>
